...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-repo-panel': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  'packages/client/ui-browser-panel': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  'packages/client/ui-terminal-panel': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/api/gui-repo': { kind: 'none', reason: 'The namespace serves only the browser repository environment panel; no verb reaches a model request.' },
  'packages/api/gui-terminal': { kind: 'none', reason: 'The namespace serves only the browser terminal panel; no verb reaches a model request.' },
