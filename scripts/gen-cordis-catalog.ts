...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  guiRepoController: 'workspace.md',
  sandbox: 'sandbox.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  BrowserOwner: 'browser.md',
  BrowserPageState: 'browser.md',
  BrowserNavigateRequest: 'browser.md',
  BrowserNavigation: 'browser.md',
  BrowserObservation: 'browser.md',
  BrowserObserveRequest: 'browser.md',
  BrowserActOutcome: 'browser.md',
  BrowserActRequest: 'browser.md',
  BrowserScreenshot: 'browser.md',
  BrowserScreenshotRequest: 'browser.md',
  BrowserConsolePage: 'browser.md',
  BrowserConsoleRequest: 'browser.md',
  BrowserEvaluateRequest: 'browser.md',
  BrowserEvaluateResult: 'browser.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  GuiRepoBranchesRequest: 'repository environment branch listing request is owned by packages/api/gui-repo/README.md',
  GuiRepoBranchesValue: 'repository environment branch listing result is owned by packages/api/gui-repo/README.md',
  GuiRepoBranchMutationValue: 'repository environment branch mutation result is owned by packages/api/gui-repo/README.md',
  GuiRepoCheckoutRequest: 'repository environment checkout request is owned by packages/api/gui-repo/README.md',
  GuiRepoCreateBranchRequest: 'repository environment create-branch request is owned by packages/api/gui-repo/README.md',
  GuiRepoStatusRequest: 'repository environment status request is owned by packages/api/gui-repo/README.md',
  GuiRepoStatusValue: 'repository environment status result is owned by packages/api/gui-repo/README.md',
