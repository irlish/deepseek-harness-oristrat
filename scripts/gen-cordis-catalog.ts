...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GuiRepoSource: 'workspace.md',
  GuiRepoStatusRequest: 'workspace.md',
  GuiRepoStatusValue: 'workspace.md',
  GuiRepoBranchesRequest: 'workspace.md',
  GuiRepoBranchesValue: 'workspace.md',
  GuiRepoCheckoutRequest: 'workspace.md',
  GuiRepoCreateBranchRequest: 'workspace.md',
  GuiRepoBranchMutationValue: 'workspace.md',
  GuiTerminalOutputFrame: 'terminal.md',
  GuiTerminalOpenRequest: 'terminal.md',
  GuiTerminalOpenValue: 'terminal.md',
  GuiTerminalWriteRequest: 'terminal.md',
  GuiTerminalCloseRequest: 'terminal.md',
  GuiTerminalSessionSummary: 'terminal.md',
  GuiTerminalOutputRequest: 'terminal.md',
  GuiTerminalReadValue: 'terminal.md',
  Reload: 'boot.md',
  PluginInfo: 'boot.md',
  BundleInfo: 'boot.md',
