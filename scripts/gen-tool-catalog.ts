...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  },
  {
    ...
    note:
      'The browser tools wait for `ctx.browser`: a deployment whose composition mounts no browser provider registers none of them. Every action reports the page state it produced, and screenshots return an image block.',
  },
]
