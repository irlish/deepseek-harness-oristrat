 ...
 * first. With nothing to list, activating the composer surface opens the
 * picker menu whose entries are the no-Workspace choice and the add action;
 * the helper takes the add entry, which raises the dialog. The directory is staged here
