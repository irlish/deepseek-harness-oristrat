...
export const en = {
  ...
  aboutMenu: 'About Oristrat AI Stem',
  aboutProduct: 'Oristrat AI Stem',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide Oristrat AI Stem',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Oristrat AI Stem',
  openApplication: 'Open Oristrat AI Stem',
  quit: 'Quit',
  cancel: 'Cancel',
  quitTitle: 'Quit Oristrat AI Stem?',
  ...
  startupFailed: 'Oristrat AI Stem is unavailable',
  ...
  welcomeTitle: 'Oristrat AI Stem',
  welcomeBrand: 'Oristrat AI Stem',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Oristrat AI Stem',
  welcomeTaglineAfter: '',
  ...
  welcomeKeyDescription: 'Configure Oristrat official models to get started',
  ...
  updateDownloadedTitle: 'Oristrat AI Stem v{version} downloaded',
  ...
  updateTitle: 'Oristrat AI Stem Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Oristrat AI Stem {version}\n\nOristrat AI Stem will restart to complete the update.',
...
export const zh = {
  ...
  fileMenu: '文件',
  closePage: '关闭页面或窗口',
  aboutMenu: '关于 Oristrat AI Stem',
  aboutProduct: 'Oristrat AI Stem',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 Oristrat AI Stem',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Oristrat AI Stem',
  openApplication: '打开 Oristrat AI Stem',
  quit: '退出',
  cancel: '取消',
  quitTitle: '退出 Oristrat AI Stem？',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Oristrat AI Stem 无法使用',
  ...
  welcomeKeyDescription: '配置 Oristrat 官方模型，即可开始使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Oristrat AI Stem v{version} 下载完成',
  ...
  updateTitle: 'Oristrat AI Stem 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Oristrat AI Stem {version}\n\nOristrat AI Stem 将重启以完成更新。',
