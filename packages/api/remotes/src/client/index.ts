...
import guiTerminalRemote from '@deepseek-ai/dsh-api-gui-terminal/remote'
import guiRepoRemote from '@deepseek-ai/dsh-api-gui-repo/remote'
...
export type {} from '@deepseek-ai/dsh-api-gui-terminal/remote'
export type * from '@deepseek-ai/dsh-api-gui-terminal/types'
export type {} from '@deepseek-ai/dsh-api-gui-repo/remote'
export type * from '@deepseek-ai/dsh-api-gui-repo/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, workspaceFilesRemote, guiTerminalRemote, guiRepoRemote,
    ]) {
