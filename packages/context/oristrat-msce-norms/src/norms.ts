/**
 * The always-on Oristrat MSCE development norms section text.
 *
 * Condensed normative core of the `msce-engine-app-development` skill: enough
 * to govern every code change without a skill invocation, with pointers into
 * the installed skill for the full checklists and review procedures.
 */

/** System-prompt section text contributed by this plugin. */
export const MSCE_NORMS_PROMPT = `# Oristrat MSCE 开发规范（常驻）
