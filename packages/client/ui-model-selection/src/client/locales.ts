...
export const zh = {
  ...
  'slider.aria': '推理等级滑块，当前 {effort}',
  'slider.unset': '跟随提供商默认',
  'effort.level.off': '关闭',
  'effort.level.minimal': '最低',
  'effort.level.low': '低',
  'effort.level.medium': '中',
  'effort.level.high': '高',
  'effort.level.xhigh': '极高',
  'effort.level.max': '最高',
  'effort.highestHint': '更高推理强度可能更快消耗使用额度',
...
export const en = {
  ...
  'menu.effort': 'Effort',
  'effort.providerDefault': 'Default',
  'slider.aria': 'Reasoning effort slider, current {effort}',
  'slider.unset': 'Provider default',
  ...
  'effort.highestHint': 'Higher reasoning effort may use your quota faster',
