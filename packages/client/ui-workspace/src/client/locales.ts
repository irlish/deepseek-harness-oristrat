...
export const zh = {
  ...
  'empty.none': '暂无会话',
  'empty.unassigned': '未关联工作区的会话会显示在这里',
  ...
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话将显示在“最近会话”下。',
...
export const en = {
  ...
  'empty.unassigned': 'Sessions without a workspace appear here',
  ...
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept. Its sessions will appear under Recent Sessions.',
