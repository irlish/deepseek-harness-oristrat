...
export const en = {
  ...
  add: 'Add provider',
  fetchUpstream: 'Fetch upstream models',
  fetchResult: 'Upstream models fetched and merged into the catalog',
  provider: 'Provider',
  close: 'Close',
  cancel: 'Cancel',
  apply: 'Apply',
  ...
  onboardingDescription: 'Configure Oristrat - official (custom API URL supported) to start building.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  add: '添加提供方',
  fetchUpstream: '获取上游模型',
  fetchResult: '已获取上游模型并合并到目录',
  provider: '提供方',
  close: '关闭',
  cancel: '取消',
  apply: '保存',
  ...
  onboardingDescription: '配置 Oristrat - official（支持自定义 API URL），即可开始使用。',
