  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        parameters: [{ name: 'workspaceId', description: 'explicit target; absent inherits the current or most recent Workspace, or lands in the unassigned bucket when none exists.' }],
      },
      {
