...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Extension entries sharing the composer prompt row ahead of the editor.',
    doc: 'Extension entries sharing the composer prompt row ahead of the editor.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-repo-panel RepoEnvAction id \'repo-env\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-browser-panel BrowserTabBody',
      ...
      'client-ui-terminal-panel TerminalTabBody',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'rightbar.session\' (client-ui-sidebar-right), so it exists while that entry is mounted',
    occupants: [
      'client-ui-browser-panel BrowserTitle',
      ...
      'client-ui-terminal-panel TerminalTitle',
    ],
    replaceRisk: 'none',
